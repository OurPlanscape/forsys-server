...
RUN R -e "options(warn = 2); library(remotes); remotes::install_github('forsys-sp/patchmax@3a5738133de72784e2366865a0049710f4edb0b8')"
RUN R -e "options(warn = 2); library(remotes); remotes::install_github('forsys-sp/forsysr@7e98245c9731c0c3bcdd727e34fc38dbd071036b')"
